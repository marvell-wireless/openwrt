...
define Profile/armada-lp-3720-db
  NAME:=Marvell Armada 3720 DB (DB-88F3720)
  CPU_TYPE:=cortex-a53
  CPU_SUBTYPE:=neon-vfpv4
  PACKAGES:= kmod-marvell-sata kmod-scsi-generic kmod-fs-ext4 kmod-fs-msdos kmod-fs-ntfs kmod-usb-core kmod-usb-ohci kmod-usb-uhci kmod-usb-storage kmod-usb-storage-extras kmod-usb2 kmod-usb3 usbutils kmod-mmc mmc-utils kmod-mtd-rw kmod-nbd pciutils fdisk lsblk kmod-ipsec kmod-mwlwifi wpad-mini
endef

define Profile/armada-lp-3720-db/Description
  Package set compatible with the Armada 88F3720 Development Board.
endef

$(eval $(call Profile,armada-a8k-8040-db))
$(eval $(call Profile,armada-a7k-7040-db))
$(eval $(call Profile,armada-lp-3720-db))
